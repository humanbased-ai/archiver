module github.com/cfp-greenfield

go 1.23.4

require (
	github.com/bnb-chain/greenfield-go-sdk v1.7.3
...
require (
	...
	github.com/bnb-chain/greenfield v1.9.1-0.20240919130019-f3630e653d05 // indirect
