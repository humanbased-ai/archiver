...
echo $parent_path/eigenlayer-deployed-anvil-state.json
...
[[ -a script/output/devnet/M2_from_scratch_deployment_data.json ]] && mv script/output/devnet/M2_from_scratch_deployment_data.json script/output/devnet/M2_from_scratch_deployment_data.json.bak
...
[[ -a script/output/devnet/M2_from_scratch_deployment_data.json ]] && mv script/output/devnet/M2_from_scratch_deployment_data.json ../../../../script/output/31337/eigenlayer_deployment_output.json
[[ -a script/output/devnet/M2_from_scratch_deployment_data.json.bak ]] && mv script/output/devnet/M2_from_scratch_deployment_data.json.bak script/output/devnet/M2_from_scratch_deployment_data.json
