...
import {VotingDigestServiceManager, IServiceManager} from "../src/VotingDigestServiceManager.sol";
...
contract AddStrategyScript is Script, Utils {
    ...
    address votingDigestServiceManagerProxyAddr;
    ...
    function run() external {
        ...
        _updateVotingDigestAVS(erc20MockStrategy);
    }
    ...
    function _updateVotingDigestAVS(StrategyBaseTVLLimits erc20MockStrategy) internal {
        ...
        VotingDigestServiceManager votingDigestServiceManagerProxy = VotingDigestServiceManager(votingDigestServiceManagerProxyAddr);
