...
2. ACTIONS: Generate one action at a time.
...
4. Please use scroll_down action with caution.
...
7. Form filling:
   ...
   - After clicking an element that triggers a suggestion list, make sure to select an option or click the ‘done’ button to confirm that the content is properly entered before proceeding to the next step.
"""
...
2. Plan next to accomplish the given task
