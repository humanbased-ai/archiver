...
SERVICE_NAME=ims-0.0.1-SNAPSHOT
...
case "$1" in 
	start)
		...
		then
			...
			exec nohup java -Xms128m -Xmx512m -jar /home/cytomine/ims/ims-0.0.1-SNAPSHOT.jar --spring.profiles.active=${SPRING_PROFILES_ACTIVE} >/dev/null 2>&1 &
			echo "start success"
		else
