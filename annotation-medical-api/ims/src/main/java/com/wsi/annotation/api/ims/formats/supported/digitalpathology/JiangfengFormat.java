...
@Slf4j
public class JiangfengFormat extends SupportedImageFormat {
    @Override
    ...
    public Map<String, Object> properties() throws IOException {
        ...
        try {
            if(this.detect()){
                ...
                properties.put("cytomine.width", obj.getInteger("khiImageWidth"));
                properties.put("cytomine.height", obj.getInteger("khiImageHeight"));
                properties.put("cytomine.resolution", obj.getDouble("khiImageCapRes"));
                properties.put("cytomine.magnification", obj.getInteger("khiScanScale"));
            }
        } catch (InterruptedException e) {
            throw new RuntimeException(e);
        }
    ...
    private String runCmd(Integer type,String path){
        ...
        String result = null;
        try {
            String[] command = {"./jiangfeng/main", type.toString(), path};
