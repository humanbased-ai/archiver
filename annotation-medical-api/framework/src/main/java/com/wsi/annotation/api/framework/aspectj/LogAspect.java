...
import com.wsi.annotation.api.common.enums.BusinessStatus;
import com.wsi.annotation.api.common.enums.HttpMethod;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.wsi.annotation.api.common.annotation.Log)")
