...
import com.wsi.annotation.api.common.core.text.Convert;
...
public class ServletUtils {
    ...
    public static Double getParameterToDouble(String name) {
        return Convert.toDouble(getRequest().getParameter(name));
    }
    ...
    public static Double getParameterToDouble(String name, Double defaultValue) {
        return Convert.toDouble(getRequest().getParameter(name), defaultValue);
    }
    ...
    public static Map<String, Object> getParameterMap() {
        ...
        map.entrySet().forEach(x -> resultMap.put(x.getKey(), StringUtils.join(x.getValue(), ",")));
        return resultMap;
    }
    ...
    public static String getCookie(HttpServletRequest request, String name) {
        javax.servlet.http.Cookie cookie = org.springframework.web.util.WebUtils.getCookie(request, name);
