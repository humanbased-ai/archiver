...
public class DictUtils
{
    ...
    {
        String cacheObj = SpringUtils.getBean(RedisCache.class).getCacheObject(getCacheKey(key));
        if (StringUtils.isNotNull(cacheObj))
        {
            List<SysDictData> dictDatas =  JSONObject.parseArray(cacheObj,SysDictData.class);
            return dictDatas;
        }
        return null;
    }
