...
import type { SDKContextType, SDKProviderProps, SDKContextItem } from './sdk-provider.types'
...
export function SDKProvider({ children, acceptCustomStyles, debug }: SDKProviderProps) {
  ...
  const mutateCache = useCallback((mutate?: (state: Map<AnyFn, SDKContextItem<any>>) => void) => {
