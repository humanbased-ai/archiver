<template>
  <div class="register">
    <el-form ref="registerForm" :model="registerForm" :rules="registerRules" class="register-form">
      <h3 class="title">Codatta </br>Medical Image Annotation Platform</h3>
      <el-form-item prop="username">
        <el-input v-model="registerForm.username" type="text" auto-complete="off" placeholder="email">
      ...
      <el-form-item style="width:100%;margin-bottom: 8px;">
        <el-button
          :loading="loading"
          size="medium"
          type="primary"
