...
@scheduler_router.get("/api/task/config/list", summary="查看任务")
#@check_login()
...
@scheduler_router.get("/api/task/config/jobs", summary="查看任务")
#@check_login()
async def list_test(request: Request):
...
@scheduler_router.post("/api/task/config/run", summary="立即执行")
#@check_login()
...
@scheduler_router.post("/api/task/config/fresh", summary="启动停止")
#@check_login()
...
@scheduler_router.post("/api/task/config/remove", summary="爬取chainabuse")
#@check_login()
